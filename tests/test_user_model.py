...
class UserModelTestCase(unittest.TestCase):
    ...
    def test_password_verification(self):
        ...
        self.assertFalse(u.verify_password('Admin'))

    def test_password_salts_are_random(self):
        u1=User(password='User')
    ...
    def test_valid_reset_token(self):
        ...
        self.assertTrue(User.reset_password(token,'Admin'))
        self.assertTrue(u.verify_password('Admin'))
    ...
    def test_invalid_reset_token(self):
        ...
        db.session.commit()
        token = u.generate_reset_token()
        self.assertFalse(User.reset_password(token+'a','Admin'))
        self.assertTrue(u.verify_password('User'))
        
    def test_valid_email_change_token(self):
        u = User(email='siva@example.com',password='User')
        db.session.add(u)
        db.session.commit()
        token = u.generate_email_change_token('tejas@example.org')
        self.assertTrue(u.change_email(token))
        self.assertTrue(u.email == 'tejas@example.org')
