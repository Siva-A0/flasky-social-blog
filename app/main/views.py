from flask import make_response, render_template, request, redirect, url_for, current_app, flash, abort
from .. import db
...
def unfollow(username):
    ...
    db.session.commit()
    flash(f'You are now not following {username} anymore.')
    return redirect(url_for('.user', username=username))
